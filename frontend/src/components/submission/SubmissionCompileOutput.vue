...
<template>
  <section class="compile-panel" :class="{ 'compile-panel--embedded': embedded }"
    aria-labelledby="compile-output-title">
...
.terminal {
  ...
  color: #9f2f2b;
  background: #fff7f6;
  font: 12px/1.75 "Cascadia Code", "JetBrains Mono", Consolas, monospace;
